...
class ConfigProcessor:
    ...
    def _generate_readme(self, simple_entries: List[Tuple[str, str]], complex_entries: List[Tuple[str, str]]) -> None:
        ...
        md_content.extend([
            ...
            "|[Clash Nyanpasu](https://github.com/libnyanpasu/clash-nyanpasu)|Minimalist design, lightweight, easy to use, focused on essential features.|Fast, low resource usage.|Lacks advanced routing and load balancing.|Clash.Meta, Clash, Mihomo, Mihomo Alpha|HTTP, HTTPS, SOCKS5, Shadowsocks, VMess, VLESS, Trojan, Snell, Hysteria, Tuic|",
            ...
            "|[Clash.Mini](https://github.com/MetaCubeX/Clash.Mini)|Minimalistic client for essential routing, low resource usage.|Fast, portable.|No advanced GUI, limited proxy management.|Clash.Meta|HTTP, HTTPS, SOCKS5|",
            "|[ClashX.Meta](https://github.com/MetaCubeX/ClashX.Meta)|macOS style interface on Windows, rich feature set including rule-based routing, DNS over HTTPS.|Advanced features, cross-platform compatibility.|Occasional UI glitches, slightly higher resource usage.|Clash.Meta|HTTP, HTTPS, SOCKS5, Shadowsocks, VMess, VLESS|",
            ...
            "|[FlClash](https://github.com/chen08209/FlClash)|Multi-platform, open-source, ad-free, supports advanced rules and proxies.|Simple, ad-free, stable.|Limited GUI customization.|Clash.Meta, Clash|HTTP, HTTPS, SOCKS5, Shadowsocks, VMess, VLESS|",
            ...
            "|[Pandora Box](https://github.com/libnyanpasu/libnyanpasu.github.io)|Advanced features, supports multiple proxies, rule management, DNS over HTTPS.|Robust features.|Heavier than most clients.|Clash.Meta|HTTP, HTTPS, SOCKS5, Shadowsocks, VMess, VLESS, Trojan, Snell, Wireguard|",
            ...
            "|[Clash Mi Desktop](https://github.com/KaringX/clashmi)|User-friendly, minimalistic, supports basic proxy management and subscriptions.|Simple, portable.|Lacks advanced features.|Clash.Meta, Clash|HTTP, HTTPS, SOCKS5, Shadowsocks|",
            "### MacOS",
            "|Client|Description|Pros|Cons|Supported cores|Supported agents|",
            "|-|-|-|-|-|-|",
